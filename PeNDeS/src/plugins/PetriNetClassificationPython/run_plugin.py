"""
This script is called by the plugin-wrapper, PetriNetClassificationPython.js, which passes down the
...
from PetriNetClassificationPython import PetriNetClassificationPython
...
plugin = PetriNetClassificationPython(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
